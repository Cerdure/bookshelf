...
$(".top-back-title").show();
$(".middle-nav-underbar").css('left','75%');
  ...
  $(".winner-write").click(function(){
    $(".write-wrapper-back").addClass("modal-background");
    $(".winner-write-wrapper").fadeIn(200);
    $("body").css('overflow-y','hidden');
    iwOpened = true;
  });
  $(".winner-write-top-icon").click(function(){
    $(".winner-write-wrapper").css('filter','brightness(0.5)');
    $(".close-alert").show();
  });
